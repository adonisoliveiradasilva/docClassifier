...
from api.src.domain.response_http import ResponseErrorModel, ResponseBadRequest, ResponseWithPredictionDocs, ResponseHTTP422
...
def model_classify_docs(documentType: str = Form(...),
    ...
    try:
        ...
        return ResponseHTTPHandler.create(
            **data,
            message="Imagem classificada com sucesso"
        )
